...
>(({ index, className, ...props }, ref) => {
  ...
  // Safety check - if the context or slots array doesn't exist, render a basic slot
  ...
  // Check if slot exists at the given index and assign it a proper type
